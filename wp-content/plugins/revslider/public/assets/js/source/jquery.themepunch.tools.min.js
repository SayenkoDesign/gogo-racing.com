...
(function (factory) {
	...
	* @property {function} [swipe=null] A handler to catch all swipes. See {@link jQuery.fn.swipe#event:swipe}
	* @property {function} [swipeLeft=null] A handler that is triggered for "left" swipes. See {@link jQuery.fn.swipe#event:swipeLeft}
	* @property {function} [swipeRight=null] A handler that is triggered for "right" swipes. See {@link jQuery.fn.swipe#event:swipeRight}
	* @property {function} [swipeUp=null] A handler that is triggered for "up" swipes. See {@link jQuery.fn.swipe#event:swipeUp}
	* @property {function} [swipeDown=null] A handler that is triggered for "down" swipes. See {@link jQuery.fn.swipe#event:swipeDown}
	* @property {function} [swipeStatus=null] A handler triggered for every phase of the swipe. See {@link jQuery.fn.swipe#event:swipeStatus}
	* @property {function} [pinchIn=null] A handler triggered for pinch in events. See {@link jQuery.fn.swipe#event:pinchIn}
	* @property {function} [pinchOut=null] A handler triggered for pinch out events. See {@link jQuery.fn.swipe#event:pinchOut}
	* @property {function} [pinchStatus=null] A handler triggered for every phase of a pinch. See {@link jQuery.fn.swipe#event:pinchStatus}
	* @property {function} [tap=null] A handler triggered when a user just taps on the item, rather than swipes it. If they do not move, tap is triggered, if they do move, it is not. 
	* @property {function} [doubleTap=null] A handler triggered when a user double taps on the item. The delay between taps can be set with the doubleTapThreshold property. See {@link jQuery.fn.swipe.defaults#doubleTapThreshold}
	* @property {function} [longTap=null] A handler triggered when a user long taps on the item. The delay between start and end can be set with the longTapThreshold property. See {@link jQuery.fn.swipe.defaults#longTapThreshold}
	* @property (function) [hold=null] A handler triggered when a user reaches longTapThreshold on the item. See {@link jQuery.fn.swipe.defaults#longTapThreshold}
	* @property {boolean} [triggerOnTouchEnd=true] If true, the swipe events are triggered when the touch end event is received (user releases finger).  If false, it will be triggered on reaching the threshold, and then cancel the touch event automatically. 
	* @property {boolean} [triggerOnTouchLeave=false] If true, then when the user leaves the swipe object, the swipe will end and trigger appropriate handlers. 
	* @property {string|undefined} [allowPageScroll='auto'] How the browser handles page scrolls when the user is swiping on a touchSwipe object. See {@link jQuery.fn.swipe.pageScroll}.  <br/><br/>
	...
	* @namespace
	* @readonly
	* @see jQuery.fn.swipe.defaults#allowPageScroll
	...
	* @namespace
	* @readonly
	* @see jQuery.fn.swipe.defaults#fingers
	...
	* Do not use this to construct your TouchSwipe object, use the jQuery plugin method $.fn.swipe(); {@link jQuery.fn.swipe}
	* @private
	* @name TouchSwipe
	* @param {DOMNode} element The HTML DOM object to apply to plugin to
	* @param {Object} options The options to configure the plugin with.  @link {$.fn.swipe.defaults}
	* @see jQuery.fh.swipe.defaults
	* @see jQuery.fh.swipe
    * @class
	*/
	function TouchSwipe(element, options) {
		...
		* @param {string} phase the phase of the swipe (start, end cancel etc) {@link jQuery.fn.swipe.phases}
		* @inner
		*/
		...
		* @param {object} event the original event object
		* @param {string} phase the phase of the swipe (start, end cancel etc) {@link jQuery.fn.swipe.phases}
		* @param {string} gesture the gesture to trigger a handler for : PINCH or SWIPE {@link jQuery.fn.swipe.gestures}
		...
		* @param {string} direction The direction of the event. See {@link jQuery.fn.swipe.directions}
		* @see jQuery.fn.swipe.directions
		* @inner
		*/
		...
		* @return string Either {@link jQuery.fn.swipe.directions.IN} or {@link jQuery.fn.swipe.directions.OUT}
		* @see jQuery.fn.swipe.directions
		* @inner
		*/
		...
		* @param {point} startPoint A point object containing x and y co-ordinates
	    * @param {point} endPoint A point object containing x and y co-ordinates
	    * @return string Either {@link jQuery.fn.swipe.directions.LEFT} / {@link jQuery.fn.swipe.directions.RIGHT} / {@link jQuery.fn.swipe.directions.DOWN} / {@link jQuery.fn.swipe.directions.UP}
		* @see jQuery.fn.swipe.directions
		* @inner
		*/
 ...
 * @name jQuery.fn.swipe#swipe
 * @event
 * @default null
 * @param {EventObject} event The original event object
 * @param {int} direction The direction the user swiped in. See {@link jQuery.fn.swipe.directions}
 * @param {int} distance The distance the user swiped
 * @param {int} duration The duration of the swipe in milliseconds
 * @param {int} fingerCount The number of fingers used. See {@link jQuery.fn.swipe.fingers}
 ...
 * @name jQuery.fn.swipe#swipeLeft
 * @event
 * @default null
 * @param {EventObject} event The original event object
 * @param {int} direction The direction the user swiped in. See {@link jQuery.fn.swipe.directions}
 ...
 * @name jQuery.fn.swipe#swipeRight
 * @event
 * @default null
 * @param {EventObject} event The original event object
 * @param {int} direction The direction the user swiped in. See {@link jQuery.fn.swipe.directions}
 ...
 * @name jQuery.fn.swipe#swipeDown
 * @event
 * @default null
 * @param {EventObject} event The original event object
 * @param {int} direction The direction the user swiped in. See {@link jQuery.fn.swipe.directions}
 ...
 * @name jQuery.fn.swipe#swipeStatus
 * @event
 * @default null
 * @param {EventObject} event The original event object
 * @param {string} phase The phase of the swipe event. See {@link jQuery.fn.swipe.phases}
 * @param {string} direction The direction the user swiped in. This is null if the user has yet to move. See {@link jQuery.fn.swipe.directions}
 ...
 * @name jQuery.fn.swipe#pinchIn
 * @event
 * @default null
 * @param {EventObject} event The original event object
 * @param {int} direction The direction the user pinched in. See {@link jQuery.fn.swipe.directions}
 ...
 * @name jQuery.fn.swipe#pinchStatus
 * @event
 * @default null
 * @param {EventObject} event The original event object
 * @param {int} direction The direction the user pinched in. See {@link jQuery.fn.swipe.directions}
 ...
 * @name jQuery.fn.swipe#click
 * @event
 * @deprecated since version 1.6.2, please use {@link jQuery.fn.swipe#tap} instead
 * @default null
 * @param {EventObject} event The original event object
 ...
 * You can set the time delay for a double tap with the {@link jQuery.fn.swipe.defaults#doubleTapThreshold} property.
 * Note: If you set both <code>doubleTap</code> and <code>tap</code> handlers, the <code>tap</code> event will be delayed by the <code>doubleTapThreshold</code>
 * as the script needs to check if its a double tap.
 * @name jQuery.fn.swipe#doubleTap
 * @see  jQuery.fn.swipe.defaults#doubleTapThreshold
 * @event
 * @default null
 * @param {EventObject} event The original event object
 * @param {DomObject} target The element clicked on.
 ...
 * You can set the time delay for a long tap with the {@link jQuery.fn.swipe.defaults#longTapThreshold} property.
 * @name jQuery.fn.swipe#longTap
 * @see  jQuery.fn.swipe.defaults#longTapThreshold
 * @event
 * @default null
 * @param {EventObject} event The original event object
 * @param {DomObject} target The element clicked on.
